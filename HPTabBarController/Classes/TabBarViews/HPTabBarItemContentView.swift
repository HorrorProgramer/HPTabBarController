//
//  HPTabBarItemContentView.swift
//  HPTabBarItemContentView
//
...
public enum HPTabBarItemContentMode: Int {
...
/**
 * @title HPTabBarItemContentView
 * @breif 自定义TabBar Item显示界面
 */
open class HPTabBarItemContentView: UIView {
    // MARK: Properties
    ...
    open var itemContentMode: HPTabBarItemContentMode = .alwaysTemplate {
        didSet {
            self.updateDisplay()
        }
    }
    ...
    open var badgeColor: UIColor? {
        didSet {
            if let _ = badgeColor {
                ...
                self.badgeView.badgeColor = HPTabBarItemBadgeView.defaultBadgeColor
            }
        }
    }
    open var badgeView: HPTabBarItemBadgeView = HPTabBarItemBadgeView() {
        willSet {
