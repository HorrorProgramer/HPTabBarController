...
/*
 * @description HPTabBarItem继承自UITabBarItem，目的是为ESTabBarItemContentView提供UITabBarItem属性的设置。
 ...
 */
@available(iOS 8.0, *)
open class HPTabBarItem: UITabBarItem {
    
    /// Customize content view
    open var contentView: HPTabBarItemContentView?
     ...
     */
    public init(_ contentView: HPTabBarItemContentView = HPTabBarItemContentView(), title: String? = nil, image: UIImage? = nil, selectedImage: UIImage? = nil, tag: Int = 0) {
        super.init()
