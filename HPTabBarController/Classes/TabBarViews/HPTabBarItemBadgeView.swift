//
//  HPTabBarItemBadgeView.swift
//  HPTabBarItemBadgeView
//
...
/*
 *  @title HPTabBarItemBadgeView
 *  @briefHPTabBarItemBadgeView,这个类定义了item中使用的badge视图样式，默认为HPTabBarItemBadgeView类对象。,你可以设置HPTabBarItemContentView的badgeView属性为自定义的HPTabBarItemBadgeView子类，这样就可以轻松实现 自定义通知样式了。
 */
open class HPTabBarItemBadgeView: UIView {
    /// 默认颜色
